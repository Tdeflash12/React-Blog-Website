...
<div className="flex  w-screen h-screen bg-red-400">
	...
	<div className="container mx-auto my-3 px-4 lg:px-20">
		...
		<div className="w-full p-8 my-4 md:px-12 lg:w-9/12 lg:pl-20 lg:pr-40 mr-auto rounded-2xl shadow-2xl bg-yellow-700 mt-3">
			<div className="flex">
				<h1 className="font-bold uppercase text-5xl">Create a <br />Blog</h1>
			</div>
